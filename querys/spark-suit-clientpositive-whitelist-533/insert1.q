...
explain insert into table spark_suit_db.INSERT1 select a.key, a.value from insert2 a WHERE (a.key=-1);
...
INSERT OVERWRITE TABLE result SELECT 'db2_insert1' FROM spark_suit_db.src LIMIT 1;
INSERT INTO TABLE result SELECT 'db2_insert2' FROM spark_suit_db.src LIMIT 1;

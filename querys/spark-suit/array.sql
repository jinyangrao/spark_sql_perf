...
create or replace temporary view data as select * from values
...
create or replace temporary view primitive_arrays as select * from values (
  array(true),
  array(2Y, 1Y),
  array(2S, 1S),
  array(2, 1),
...
drop view if exists primitive_arrays;

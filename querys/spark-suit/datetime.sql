...
create or replace temporary view ttf1 as select * from values
  (1, 2),
  (2, 3)
...
create or replace temporary view ttf2 as select * from values
  (1, 2),
  (2, 3)
  as ttf2(a, b);
...
-- Clean up
DROP VIEW IF EXISTS ttf1;
DROP VIEW IF EXISTS ttf2;

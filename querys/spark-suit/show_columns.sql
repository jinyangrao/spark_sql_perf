...
CREATE OR REPLACE TEMPORARY VIEW showColumn3 (col3 int, `col 4` int) USING json;
CREATE OR REPLACE GLOBAL TEMP VIEW showColumn4 AS SELECT 1 as col1, 'abc' as `col 5`;
